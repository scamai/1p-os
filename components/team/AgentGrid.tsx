  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
      {agents.map((agent) => (
        <div
          key={agent.id}
          className="group relative cursor-pointer rounded-lg border border-zinc-200 bg-white p-4 transition-all hover:shadow-md"
        ...
        >
          ...
          {onDelete && confirmId !== agent.id && (
            <button
              ...
              className="absolute right-3 top-3 hidden rounded p-1 text-zinc-400 transition-colors hover:text-zinc-700 group-hover:block"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <span className="inline-block mt-0.5 rounded-full border border-zinc-200 bg-zinc-50 px-2 py-0.5 text-[10px] font-medium text-zinc-600">
                {agent.role}
              </span>
            </div>
          </div>
