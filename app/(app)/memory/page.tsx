      ...
      {data.map((d) => {
        ...
        return (
          <div key={d.date} className="group relative flex-1 flex flex-col items-center justify-end">
            <div
              className="w-full rounded-t bg-zinc-900 transition-all hover:bg-zinc-700"
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mb-1 flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold text-zinc-900">Memory</h1>
        ...
        >
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-[13px] text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900 resize-none"
            />
          </div>
          <div className="flex gap-3">
            <div className="flex-1">
              ...
              <select
                ...
                className="w-full h-8 rounded-md border border-zinc-200 bg-white px-2 text-[13px] text-zinc-700 focus:outline-none focus:ring-2 focus:ring-zinc-900"
              >
                {CATEGORIES.map((c) => (
          ...
          <div className="flex justify-end">
            <button
              ...
              className="h-8 rounded-md bg-zinc-900 px-4 text-[13px] font-medium text-white transition-opacity hover:opacity-90 disabled:opacity-50"
            >
      ...
      {/* Tabs */}
      <div className="mt-4 mb-6 flex gap-1 border-b border-zinc-200">
        {TABS.map((t) => (
          <button
            key={t.id}
            onClick={() => setTab(t.id)}
                ...
                {stats.byCategory
                  ...
                  .map((cat) => (
                    <div key={cat.category} className="flex items-center gap-3">
                      <span className="w-24 text-[13px] text-zinc-600 capitalize">
                        {cat.category}
                      </span>
                      <div className="flex-1 h-5 rounded-full bg-zinc-100 overflow-hidden">
                        <div
                          className={`h-full rounded-full transition-all ${
                            CATEGORY_BAR_COLORS[cat.category] ?? "bg-zinc-400"
                          }`}
                          style={{
                            width: `${Math.max(
                      ...
                      <span className="w-8 text-right text-[13px] tabular-nums text-zinc-500">
                        {cat.count}
                      </span>
                    </div>
                  ))}
            ...
            <div className="space-y-1.5">
              ...
              {stats.recentMemories.length > 5 && (
                <button
                  ...
                  className="mt-2 text-[12px] text-zinc-500 hover:text-zinc-700 transition-colors"
                >
              ...
              .map((day) => {
                ...
                return (
                  <div key={day.date}>
                    ...
                    <div className="space-y-1 pl-3 border-l-2 border-zinc-100">
                      {dayMemories.map((m) => (
                        <MemoryRow key={m.id} memory={m} compact />
                      ))}
                      {dayMemories.length === 0 && (
                        <p className="text-[12px] text-zinc-400 italic py-1">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            <select
              ...
              className="h-8 rounded-md border border-zinc-200 bg-white px-2 text-[13px] text-zinc-700 focus:outline-none focus:ring-2 focus:ring-zinc-900"
            >
            ...
            <span className="ml-auto text-[12px] text-zinc-400 self-center">
        ...
        <div className="space-y-4">
          <form onSubmit={handleSearch} className="flex gap-2">
            ...
            <button
              type="submit"
              disabled={searching}
              className="h-9 rounded-md bg-zinc-900 px-4 text-sm font-medium text-white transition-opacity hover:opacity-90 disabled:opacity-50"
            >
...
function MemoryRow({
  ...
  return (
    <div
      className={`group rounded-lg border border-zinc-100 bg-white transition-colors hover:bg-zinc-50 ${
        compact ? "px-3 py-2" : "px-4 py-3"
      }`}
    >
      <div className="flex items-start gap-2">
        <div className="flex-1 min-w-0">
          <p className={`text-zinc-800 ${compact ? "text-[12px]" : "text-[13px]"}`}>
