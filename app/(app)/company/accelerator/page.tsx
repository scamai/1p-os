...
const STATUS_STYLES: Record<Accelerator["status"], string> = {
  ...
  drafting: "bg-zinc-200 text-zinc-700",
  submitted: "bg-zinc-300 text-zinc-800",
  interview: "bg-zinc-800 text-white",
  accepted: "bg-zinc-900 text-white",
...
export default function AcceleratorPage() {
  ...
  return (
    <div className="mx-auto max-w-[800px]">
      ...
      <div className="mb-6">
        <h1 className="text-lg font-semibold text-zinc-900">Apply to Accelerator</h1>
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-zinc-500">{acc.location}</p>
              </div>
              <div className="flex items-center gap-2 shrink-0">
                <span className="text-[11px] text-zinc-500">{acc.investment} / {acc.equity}</span>
            ...
            {selected === acc.id && (
              <div className="border-t border-zinc-200 px-4 py-3 space-y-3">
                <div className="grid grid-cols-3 gap-4 text-[12px]">
                  <div>
                    <p className="text-zinc-500">Batch</p>
                    <p className="text-zinc-800">{acc.batch}</p>
                  </div>
                  <div>
                    <p className="text-zinc-500">Deadline</p>
                    <p className="text-zinc-800">{acc.deadline}</p>
                  </div>
                  <div>
                    <p className="text-zinc-500">Focus</p>
                    <p className="text-zinc-800">{acc.focus.join(", ")}</p>
                  </div>
                </div>

                {/* Status buttons */}
                <div className="flex items-center gap-1.5">
                  <span className="text-[11px] text-zinc-500 mr-1">Status:</span>
                ...
                <div>
                  <textarea
                    ...
                    className="w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-[12px] text-zinc-700 placeholder:text-zinc-400 focus:outline-none focus:border-zinc-300 resize-none"
                    rows={2}
                  />
                </div>
